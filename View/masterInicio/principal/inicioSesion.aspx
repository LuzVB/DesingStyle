...
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %> <%--validar caracter especiales--%>
    ...
    <tr>
        <td class="auto-style13">
           <table class="auto-style16">
                    ...
                    <asp:ScriptManager ID="ScriptManager1" runat="server"><%--validar caracter especiales--%>
                    </asp:ScriptManager>
