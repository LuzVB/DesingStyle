...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="tablaAdm">
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:FormView ID="FV_datosAdmin" runat="server" Width="100%" DataSourceID="ODS_Admin" CssClass="auto-style17">
                    <ItemTemplate>
                        <%--<table class="tablaAdm">--%>
                        <tr>
                        ...
                        <tr>
                            <td class="auto-style9">
                                <asp:TextBox ID="Tx_AdmNombre" runat="server" BorderColor="#0099FF" Width="95%" Height="25px" ValidationGroup="VG_DatosPersonales " Text='<%# Bind("nombre") %>' MaxLength="20" AutoCompleteType="Disabled"></asp:TextBox>
                                <asp:Label ID="LB_Nombre" runat="server" ForeColor="Red" Text="[LB_Nombre]" Visible="False" Width="100%"></asp:Label>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="Tx_AdmApellido" runat="server" BorderColor="#0099FF" Width="95%" Height="25px" ValidationGroup="VG_DatosPersonales " Text='<%# Bind("apellido") %>' MaxLength="20" AutoCompleteType="Disabled"></asp:TextBox>
                                <asp:Label ID="LB_Apellido" runat="server" ForeColor="Red" Text="[LB_Apellido]" Visible="False" Width="100%"></asp:Label>
                        ...
                        <tr>
                            <td class="auto-style9">
                                <asp:TextBox ID="Tx_AdmTelefono" runat="server" BorderColor="#0099FF" Width="95%" Height="25px" ValidationGroup="VG_DatosPersonales " Text='<%# Bind("telefono") %>' MaxLength="8" AutoCompleteType="Disabled"></asp:TextBox>
                                <asp:Label ID="LB_Telefono" runat="server" ForeColor="Red" Text="[LB_Telefono]" Visible="False" Width="100%"></asp:Label>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="Tx_AdmCorreo" runat="server" BorderColor="#0099FF" Width="95%" Height="25px" TextMode="Email" ValidationGroup="VG_DatosPersonales " Text='<%# Bind("correo") %>' MaxLength="40" AutoCompleteType="Disabled"></asp:TextBox>
                               <cc1:FilteredTextBoxExtender ID="FTBE_AdmCorreo" runat="server" FilterType="Numbers,LowercaseLetters, UppercaseLetters, Custom" ValidChars="_-ñ@." TargetControlID="Tx_AdmCorreo" />
                                <asp:Label ID="LB_Correo" runat="server" ForeColor="Red" Text="[LB_Correo]" Visible="False" Width="100%"></asp:Label>
        ...
        <tr>
            ...
            <td class="auto-style10">
                <asp:Button ID="BT_GuardarAdm" runat="server" Text="Guardar cambios" BorderColor="#0099FF" Font-Bold="True" Font-Size="86%" Height="30px" Width="96%" ValidationGroup="VG_DatosPersonales " OnClick="BT_GuardarAdm_Click" class="btn btn-primary" /></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style9">
                <asp:TextBox ID="Tx_AdmCActual" runat="server" BorderColor="#0099FF" Width="95%" Height="25px" ValidationGroup="VG_AContraseña" MaxLength="250" TextMode="Password" AutoCompleteType="Disabled"></asp:TextBox>
            ...
            <td class="auto-style9">
                <asp:TextBox ID="Tx_AdmCNueva" runat="server" BorderColor="#0099FF" Width="95%" Height="25px" ValidationGroup="VG_AContraseña" MaxLength="250" TextMode="Password" AutoCompleteType="Disabled"></asp:TextBox></td>
        ...
        <tr>
            ...
            <td class="auto-style10">
                <asp:Button ID="BT_GuardarContraAdm" runat="server" Text="Guardar cambios" BorderColor="#0099FF" Font-Bold="True" Font-Size="86%" Height="30px" Width="96%" ValidationGroup="VG_AContraseña" OnClick="BT_GuardarContraAdm_Click" class="btn btn-primary" /></td>
        </tr>
        <tr>
