...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style9">
                <asp:DropDownList ID="DDL_duracion" runat="server" Height="25px" Width="95%">
                    <asp:ListItem Value="0">Duracion(HH:MM)</asp:ListItem>
        ...
        <tr>
            <td class="auto-style8">
                <asp:Label ID="LB_EPrecio" runat="server" CssClass="auto-style32" Font-Size="100%" ForeColor="Red" Visible="False"></asp:Label>
            </td>
            <td class="auto-style9">
                <asp:Label ID="LB_ETiempo" runat="server" CssClass="auto-style32" Font-Size="100%" ForeColor="Red" Visible="False"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="auto-style8">&nbsp;</td>
            <td class="auto-style25">
                <asp:ImageButton ID="IB_GuardarServicio" runat="server" Height="62px" Width="15%" ValidationGroup="registroServicio" ImageUrl="~/Imagenes/guardar.png" OnClick="IB_GuardarServicio_Click" /></td>
        </tr>
    </table>
</asp:Content>
